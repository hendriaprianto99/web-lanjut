...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='dosen/skripsi' and user = '". $_SESSION['Email'] ."' and editData='1'";
...
echo "<form action=editmasterdosenskripsiexec.php method=post>";
