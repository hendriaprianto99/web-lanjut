...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='dosen/skripsi' and user = '". $_SESSION['Email'] ."' and viewData='1'";
...
echo "<tr><td colspan=2 align=center><a href=listmasterdosenskripsi.php><button type='button' class='btn btn-warning'><font face=Verdana size=1><i class='fa fa-check'></i>&nbsp;Back</font></button></a></td></tr>";
echo "</table></td></tr>";
echo "</table><br>";
echo "</div>"; 
}
