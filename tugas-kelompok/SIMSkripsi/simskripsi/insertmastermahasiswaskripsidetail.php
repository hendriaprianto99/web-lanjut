...
echo "<form action=insertmastermahasiswaskripsidetailexec.php method=post>";
...
echo "<td bgcolor=CCEEEE><input type=text id='Tanggal_Sidang' name='Tanggal_Sidang'><script type='text/javascript'>calendar.set('Tanggal_Sidang');</script></td></tr>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>Ruang_Sidang</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Ruang_Sidang' size = 100></td></tr>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>Nilai_Pembimbing</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Nilai_Pembimbing' size = 100></td></tr>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>Nilai_Penguji1</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Nilai_Penguji1' size = 100></td></tr>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>Nilai_Penguji2</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Nilai_Penguji2' size = 100></td></tr>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>Nilai_Akhir</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Nilai_Akhir' size = 100></td></tr>";
