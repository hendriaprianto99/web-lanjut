...
//cari tabel
echo "<br><br><form action=listskripsi.php method=post>
...
<th><font face=Verdana color=black size=1>Tanggal_Sidang</font></th>
<th><font face=Verdana color=black size=1>Ruang_Sidang</font></th>
<th><font face=Verdana color=black size=1>Nilai_Pembimbing</font></th>
<th><font face=Verdana color=black size=1>Nilai_Penguji1</font></th>
<th><font face=Verdana color=black size=1>Nilai_Penguji2</font></th>
<th><font face=Verdana color=black size=1>Nilai_Akhir</font></th>
...
while($row = mysqli_fetch_array($result))
  ...
  echo "<td><a class=linklist href=viewskripsi.php?id=".$row['id']."><button type='button' class='btn btn-warning'><font face=Verdana size=1><i class='fa fa-check'></i></font></button></a></td>";
  echo "<td><a class=linklist href=editskripsi.php?id=".$row['id']."><button type='button' class='btn btn-primary'><font face=Verdana size=1><i class='fa fa-edit'></i></font></button></a></td>";
  echo "<td><a class=linklist href=deleteskripsi.php?id=".$row['id']." onclick=\"return confirm('Are you sure you want to delete this data?')\"><button type='button' class='btn btn-danger'><font face=Verdana size=1><i class='fa fa-trash'></i></font></button></a></td>";
