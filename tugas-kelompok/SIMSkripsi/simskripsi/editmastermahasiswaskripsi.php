...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='mahasiswa/skripsi' and user = '". $_SESSION['Email'] ."' and editData='1'";
...
echo "<form action=editmastermahasiswaskripsiexec.php method=post>";
