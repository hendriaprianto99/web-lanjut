...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='mahasiswa/skripsi' and user = '". $_SESSION['Email'] ."' and insertData='1'";
...
echo "<form action=insertmastermahasiswaskripsiexec.php method=post enctype='multipart/form-data'>";
