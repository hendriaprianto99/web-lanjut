...
echo "<tr><td colspan=2 align=center><a href=listmasterkategori_dokumendokumendetail.php?Kode=$_GET[Kode]><button type='button' class='btn btn-warning'><font face=Verdana size=1><i class='fa fa-check'></i>&nbsp;Back</font></button></a></td></tr>";
echo "</table><br>";
echo "</div>"; 
}
