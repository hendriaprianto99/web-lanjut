...
echo "<form action=editmasterdokumendokumen_filedetailexec.php method=post>";
$result = mysqli_query($con, "SELECT * FROM dokumen_file where id = ". $_GET['id'] . "");
...
echo "<input type=hidden name='No_Dokumen' value='" . $row['No_Dokumen'] . "'</td>";
