   ...
   if( in_array($ekstensi_file, $array_tipe_file)){ 
       if( $ukuran_file <= $ukuran_maks_file ){ 
               ...
               if( move_uploaded_file($file['tmp_name'], $folder.$namaBaruFile) ){ 
				mysqli_query($con, "update pengguna set Foto='". $namaBaruFile ."' where Kode_Pengguna='". $_POST['Kode_Pengguna'] ."'"); 
				header("Location: editpengguna.php?Kode_Pengguna=". $_POST['Kode_Pengguna'] .""); 
              }else{ 
