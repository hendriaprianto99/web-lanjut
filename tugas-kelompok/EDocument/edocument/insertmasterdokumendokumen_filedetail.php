...
echo "<form action=insertmasterdokumendokumen_filedetailexec.php method=post>";
...
if (isset($_GET['No_Dokumen'])){echo "<td bgcolor=CCEEEE><font face=Verdana color=black size=1>". $_GET['No_Dokumen'] ."</font></td></tr>";}
if (isset($_GET['No_Dokumen'])){echo "<input type=hidden name='No_Dokumen' value='". $_GET['No_Dokumen'] ."'>";}
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>File</font></td>";
echo "<td bgcolor=CCEEEE><a href=uploadfiledokumen_fileinsert.php>upload</a></td></tr>";
