...
echo "<form action=insertdokumenexec.php method=post>";
...
echo "<td bgcolor=CCEEEE>";
echo "<select class='form-control' name='Nama'>";
$result = mysqli_query($con, "select * from pengguna"); 
while($r = mysqli_fetch_array($result)){
echo "<option value='". $r[Kode_Pengguna] ."'>". $r[Kode_Pengguna] ." | ". $r[Nama] ."</option>";
}
...
echo "<td bgcolor=CCEEEE>";
echo "<select class='form-control' name='Telepon'>";
$result = mysqli_query($con, "select * from pengguna"); 
while($r = mysqli_fetch_array($result)){
echo "<option value='". $r[Kode_Pengguna] ."'>". $r[Kode_Pengguna] ." | ". $r[Nama] ."</option>";
}
...
echo "<td bgcolor=CCEEEE>";
echo "<select class='form-control' name='Foto'>";
$result = mysqli_query($con, "select * from pengguna"); 
while($r = mysqli_fetch_array($result)){
echo "<option value='". $r[Kode_Pengguna] ."'>". $r[Kode_Pengguna] ." | ". $r[Nama] ."</option>";
}
