...
echo "<form action=insertmasterkategori_dokumendokumendetailexec.php method=post>";
...
if (isset($_GET['Kode'])){echo "<td bgcolor=CCEEEE><font face=Verdana color=black size=1>". $_GET['Kode'] ."</font></td></tr>";}
if (isset($_GET['Kode'])){echo "<input type=hidden name='Kode' value='". $_GET['Kode'] ."'>";}
