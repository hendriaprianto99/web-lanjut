...
?>
<?php
echo "<br><font face=Verdana color=black size=1>kategori_dokumen</font><br>";
echo "<br><a href=insertmasterkategori_dokumendokumen.php><button type='button' class='btn btn-light'><font face=Verdana color=black size=1><i class='fa fa-plus'></i>&nbsp;Insert</font></button></a><br>";
//cari tabel
echo "<br><form action=listmasterkategori_dokumendokumen.php method=post>
