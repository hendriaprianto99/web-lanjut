...
?>
<?php
echo "<br><font face=Verdana color=black size=1>jenis_pengguna</font><br><br>";
echo "<a href=insertjenis_pengguna.php><button type='button' class='btn btn-light'><font face=Verdana color=black size=1><i class='fa fa-plus'></i>&nbsp;Insert</font></button></a>";
echo "&nbsp;&nbsp;<a href='printjenis_pengguna.php' target=_blank><button type='button' class='btn btn-light'><font face=Verdana color=black size=1><i class='fa fa-print'></i>&nbsp;Print</font></button></a>";
//cari tabel
echo "<br><br><form action=listjenis_pengguna.php method=post>
