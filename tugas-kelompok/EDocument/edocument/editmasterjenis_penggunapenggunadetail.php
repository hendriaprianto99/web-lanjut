...
echo "<form action=editmasterjenis_penggunapenggunadetailexec.php method=post>";
...
echo "<input type=hidden name='Jenis_Pengguna' value='" . $row['Jenis_Pengguna'] . "'</td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Email&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Email' value='" . $row['Email'] . "' size = 100></td></tr>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Telepon&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Telepon' value='" . $row['Telepon'] . "' size = 100></td></tr>";
