...
echo "<form action=editjenis_penggunaexec.php method=post>";
...
{
echo "<tr><td colspan=2><input type=hidden name=pk value='" . $row['Jenis_Pengguna'] . "'></td></tr>";
...
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Jenis_Pengguna&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Jenis_Pengguna' value='". $row['Jenis_Pengguna'] ."' size = 100></td>";
