...
<?php
//cek otoritas
$q = "SELECT * FROM tw_hak_akses where tabel='jenis_pengguna/pengguna' and user = '". $_SESSION['Email'] ."' and editData='1'";
...
echo "<form action=editmasterjenis_penggunapenggunaexec.php method=post>";
$result = mysqli_query($con, "SELECT * FROM jenis_pengguna where Jenis_Pengguna = '". $_GET['Jenis_Pengguna'] . "'");
while($row = mysqli_fetch_array($result))
{
echo "<td bgcolor=CCEEEE><input type=hidden name=pk value='" . $row['Jenis_Pengguna'] . "'></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Jenis_Pengguna&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Jenis_Pengguna' value='" . $row['Jenis_Pengguna'] . "'></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Keterangan&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Keterangan' value='". $row['Keterangan'] ."' size = 100></td>";
