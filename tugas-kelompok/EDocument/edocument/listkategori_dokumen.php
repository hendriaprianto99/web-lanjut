...
?>
<?php
echo "<br><font face=Verdana color=black size=1>kategori_dokumen</font><br><br>";
echo "<a href=insertkategori_dokumen.php><button type='button' class='btn btn-light'><font face=Verdana color=black size=1><i class='fa fa-plus'></i>&nbsp;Insert</font></button></a>";
echo "&nbsp;&nbsp;<a href='printkategori_dokumen.php' target=_blank><button type='button' class='btn btn-light'><font face=Verdana color=black size=1><i class='fa fa-print'></i>&nbsp;Print</font></button></a>";
//cari tabel
echo "<br><br><form action=listkategori_dokumen.php method=post>
